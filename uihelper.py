...
class archerTowerElement:
    def __init__(self, image=None, position=(0, 0), anchor=None, rotation=0, scale=1, scale_x=1, scale_y=1, opacity=1, pixelated=False, group=uiGroup, callback=None, ui=False, damage=10, speed=60, radius=100):
        self.image = image
        self.width = image.width
        self.height = image.height
        self.center = image.center
